...
class NearByFisth extends StatefulWidget {
  @override
  State<NearByFisth> createState() => _NearByFisthState();
}

class _NearByFisthState extends State<NearByFisth> {
  @override
  void initState() {
    super.initState();

    Get.find<CategoryFishController>().getSubCategoryList('3');
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CategoryFishController>(builder: (catController) {
              ...
              children: [
                Padding(
                  ...
                  child: TitleWidget(
                    title: 'Premium Fish',
                    onTap: () => Get.toNamed(
                        RouteHelper.getCategoryProductRoute(3, 'Premium Fish')),
                  ),
                ),
                SizedBox(
                  height: 220,
