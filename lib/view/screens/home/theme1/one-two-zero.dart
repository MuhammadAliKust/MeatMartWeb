...
import '../../../../controller/one-two-zero.dart';

class OneTwoZeroCategory extends StatefulWidget {
  @override
  State<OneTwoZeroCategory> createState() => _OneTwoZeroCategoryState();
}

class _OneTwoZeroCategoryState extends State<OneTwoZeroCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<OneTwoZeroController>().getSubCategoryList('14');
  }
  String categoryName = "";
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (list){
      ...
      return GetBuilder<OneTwoZeroController>(builder: (catController) {
