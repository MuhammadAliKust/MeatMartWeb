...
class OneOneNineCategory extends StatefulWidget {

  @override
  State<OneOneNineCategory> createState() => _OneOneNineCategoryState();
}

class _OneOneNineCategoryState extends State<OneOneNineCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<OneOneNineController>()
        .getSubCategoryList('119');
  }
...
return GetBuilder<CategoryController>(builder: (list){
  ...
  return GetBuilder<OneOneNineController>(builder: (catController) {
      ...
      children: [
        Padding(
          ...
          child: TitleWidget(
            title: categoryName,
            onTap: () =>
                Get.toNamed(RouteHelper.getCategoryProductRoute(119, categoryName)),
          ),
        ),
        SizedBox(
          height: 220,
