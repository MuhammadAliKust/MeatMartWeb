...
import '../../../../controller/one-two-one.dart';

class OneTwoOneCategory extends StatefulWidget {

  @override
  State<OneTwoOneCategory> createState() => _OneTwoOneCategoryState();
}

class _OneTwoOneCategoryState extends State<OneTwoOneCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<OneTwoOneController>()
        .getSubCategoryList('121');
  }
...
return GetBuilder<CategoryController>(builder: (list){
  ...
  return GetBuilder<OneTwoOneController>(builder: (catController) {
      ...
      children: [
        Padding(
          ...
          child: TitleWidget(
            title:categoryName,
            onTap: () =>
                Get.toNamed(RouteHelper.getCategoryProductRoute(121, categoryName)),
          ),
        ),
        SizedBox(
          height: 220,
