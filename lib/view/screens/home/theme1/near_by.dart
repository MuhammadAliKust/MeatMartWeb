...
class NearByWidget extends StatefulWidget {
  ...
  NearByWidget({@required this.categoryName, @required this.categoryID});
...
class _NearByWidgetState extends State<NearByWidget> {
  ...
  void initState() {
    ...
    Get.find<CategoryChickenController>().getSubCategoryList('1');
  }
  ...
  Widget build(BuildContext context) {
    print("Category ID from Homepage : ${widget.categoryID}");

    return GetBuilder<CategoryChickenController>(builder: (catController) {
              ...
              children: [
                Padding(
                  ...
                  child: TitleWidget(
                    ...
                    onTap: () =>
                        Get.toNamed(RouteHelper.getCategoryProductRoute(1, 'Premium Chicken')),
                  ),
                ),
                SizedBox(
                  height: 220,
                  child: _productList != null
                      ...
                      : BestReviewedItemShimmer(_productList),
                ),
              ],
            );
    });
...
class BestReviewedItemShimmer extends StatelessWidget {
  ...
  BestReviewedItemShimmer(this._productList);
