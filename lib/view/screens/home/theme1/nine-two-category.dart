...
class NineTwoCategory extends StatefulWidget {
  @override
  State<NineTwoCategory> createState() => _NineTwoCategoryState();
}

class _NineTwoCategoryState extends State<NineTwoCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<NineTwoController>().getSubCategoryList('7');
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (list) {
      return GetBuilder<NineTwoController>(builder: (catController) {
