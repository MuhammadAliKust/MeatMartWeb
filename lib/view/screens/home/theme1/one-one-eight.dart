...
class OneOneEightCategory extends StatefulWidget {
  @override
  State<OneOneEightCategory> createState() => _OneOneEightCategoryState();
}

class _OneOneEightCategoryState extends State<OneOneEightCategory> {
  @override
  void initState() {
    super.initState();

    Get.find<OneOneEightController>().getSubCategoryList('117');
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (list) {
      return GetBuilder<OneOneEightController>(builder: (catController) {
        ...
        print(_productList.length.toString() + "Hi how");
