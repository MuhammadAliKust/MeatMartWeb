import 'package:efood_multivendor/controller/combo.dart';
...
class ComboDealWidget extends StatefulWidget {

  @override
  State<ComboDealWidget> createState() => _ComboDealWidgetState();
}

class _ComboDealWidgetState extends State<ComboDealWidget> {
  @override
  void initState() {
    super.initState();

    Get.find<CategoryComboController>()
        .getSubCategoryList('36');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CategoryComboController>(builder: (catController) {
        ...
        children: [
          Padding(
            ...
            child: TitleWidget(
              title: 'Combo Deal',
              onTap: () =>
                  Get.toNamed(RouteHelper.getCategoryProductRoute(36, 'Combo Deal')),
            ),
          ),
          SizedBox(
            height: 220,
