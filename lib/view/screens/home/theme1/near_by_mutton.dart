...
class NearByMutton extends StatefulWidget {

  @override
  State<NearByMutton> createState() => _NearByMuttonState();
}

class _NearByMuttonState extends State<NearByMutton> {
  @override
  void initState() {
    super.initState();

    Get.find<CategoryMuttonController>()
        .getSubCategoryList('2');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CategoryMuttonController>(builder: (catController) {
              ...
              children: [
                Padding(
                  ...
                  child: TitleWidget(
                    ...
                    onTap: () =>
                        Get.toNamed(RouteHelper.getCategoryProductRoute(2, 'Premium Mutton')),
                  ),
                ),
                SizedBox(
                  height: 220,
