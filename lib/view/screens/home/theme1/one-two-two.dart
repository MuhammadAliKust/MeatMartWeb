...
class OneTwoTwoCategory extends StatefulWidget {
  @override
  State<OneTwoTwoCategory> createState() => _OneTwoTwoCategoryState();
}

class _OneTwoTwoCategoryState extends State<OneTwoTwoCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<OneTwoTwoController>().getSubCategoryList('4');
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (list) {
      list.categoryList.forEach((f) {
        ...
        if (f.id == 4) {
          categoryName = f.name;
          print("Name : ${f.name.toString()}");
        }
      });
      return GetBuilder<OneTwoTwoController>(builder: (catController) {
