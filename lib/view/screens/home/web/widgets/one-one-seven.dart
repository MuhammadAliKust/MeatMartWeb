...
class OneOneSevenCategory extends StatefulWidget {
  @override
  State<OneOneSevenCategory> createState() => _OneOneSevenCategoryState();
}

class _OneOneSevenCategoryState extends State<OneOneSevenCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<OneOneSevenController>().getSubCategoryList('117');
  }
  String categoryName = "";
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (list){
      ...
      return GetBuilder<OneOneSevenController>(builder: (catController) {
