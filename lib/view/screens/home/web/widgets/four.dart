...
class FourCategory extends StatefulWidget {
  @override
  State<FourCategory> createState() => _FourCategoryState();
}

class _FourCategoryState extends State<FourCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<FourController>().getSubCategoryList('4');
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (list) {
      ...
      return GetBuilder<FourController>(builder: (catController) {
                ...
                children: [
                  Padding(
                    ...
                    child: TitleWidget(
                      title: categoryName,
                      onTap: () => Get.toNamed(
                          RouteHelper.getCategoryProductRoute(4, categoryName)),
                    ),
                  ),
                  SizedBox(
                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    height:ResponsiveHelper.isDesktop(context)? 400:220,
                                    width:ResponsiveHelper.isDesktop(context)? 370:180,
                                          ...
                                          Stack(children: [
                                            ClipRRect(
                                              ...
                                              child: CustomImage(
                                                ...
                                                height:ResponsiveHelper.isDesktop(context)? 230:125,
