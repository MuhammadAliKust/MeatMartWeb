...
class FourteenCategory extends StatefulWidget {
  @override
  State<FourteenCategory> createState() => _FourteenCategoryState();
}

class _FourteenCategoryState extends State<FourteenCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<OneOneFourController>().getSubCategoryList('14');
  }
