...
class ThreeCategory extends StatefulWidget {
  @override
  State<ThreeCategory> createState() => _ThreeCategoryState();
}

class _ThreeCategoryState extends State<ThreeCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<ThreeController>().getSubCategoryList('3');
  }
  String categoryName = "";
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (list){
      ...
      return GetBuilder<ThreeController>(builder: (catController) {
