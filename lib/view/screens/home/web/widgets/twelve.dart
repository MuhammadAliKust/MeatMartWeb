...
class TwelveCategory extends StatefulWidget {
  @override
  State<TwelveCategory> createState() => _TwelveCategoryState();
}

class _TwelveCategoryState extends State<TwelveCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<TweleveController>().getSubCategoryList('12');
  }
  String categoryName = "";
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (list){
      ...
      return GetBuilder<TweleveController>(builder: (catController) {
