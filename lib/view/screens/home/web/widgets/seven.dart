...
class SevenCategory extends StatefulWidget {
  @override
  State<SevenCategory> createState() => _SevenCategoryState();
}

class _SevenCategoryState extends State<SevenCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<SevenController>().getSubCategoryList('7');
  }
  String categoryName = "";
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (list){
      ...
      return GetBuilder<SevenController>(builder: (catController) {
