...
class TwoCategory extends StatefulWidget {
  @override
  State<TwoCategory> createState() => _TwoCategoryState();
}

class _TwoCategoryState extends State<TwoCategory> {
  @override
  void initState() {
    super.initState();
    Get.find<CategoryController>().getCategoryList(false);
    Get.find<TwoController>().getSubCategoryList('2');
  }
  String categoryName = "";
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (list){
      ...
      return GetBuilder<TwoController>(builder: (catController) {
