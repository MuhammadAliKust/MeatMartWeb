                  ...
                  return GetBuilder<OrderController>(
                    ...
                    if (restController.restaurant != null) {
                      ...
                      _streetNumberController = TextEditingController(
                          text:
                              _addressList[orderController.addressIndex].road);
                      _houseController = TextEditingController(
                          text:
                              _addressList[orderController.addressIndex].house);
                      _floorController = TextEditingController(
                          text:
                              _addressList[orderController.addressIndex].floor);
                                ...
                                child: !orderController.isLoading
                                    ? CustomButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          // if (
                                          //    ) {
                                          if (_streetNumberController
                                                  .text.isEmpty &&
                                              orderController.orderType !=
                                                  'take_away') {
                                            showCustomSnackBar(
                                                'Kindly provide street number.'
                                                    .tr);
                                          } else if (_houseController
                                                  .text.isEmpty &&
                                              orderController.orderType !=
                                                  'take_away') {
                                            showCustomSnackBar(
                                                'Kindly provide house details.'
                                                    .tr);
                                          } else if (_floorController
                                                  .text.isEmpty &&
                                              orderController.orderType !=
                                                  'take_away') {
                                            showCustomSnackBar(
                                                'Kindly provide floor details.'
                                                    .tr);
                                          }
                                          // }
