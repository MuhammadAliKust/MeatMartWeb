                  ...
                  Container(
                    ...
                    child: !orderController.isLoading ? CustomButton(buttonText: 'confirm_order'.tr, onPressed: () {
                      ...
                      if(_streetNumberController.text.isEmpty){
                        showCustomSnackBar('Kindly provide street number.'.tr);
                      }else if(_houseController.text.isEmpty){
                        showCustomSnackBar('Kindly provide house details.'.tr);
                      }else if(_floorController.text.isEmpty){
                        showCustomSnackBar('Kindly provide floor details.'.tr);
                      }
