...
import 'package:efood_multivendor/controller/four.dart';
import 'package:efood_multivendor/controller/localization_controller.dart';
import 'package:efood_multivendor/controller/location_controller.dart';
import 'package:efood_multivendor/controller/nine-two.dart';
...
import 'package:efood_multivendor/controller/one-one-eight.dart';
import 'package:efood_multivendor/controller/one-one-four.dart';
import 'package:efood_multivendor/controller/one-one-nine.dart';
import 'package:efood_multivendor/controller/one-two-two.dart';
import 'package:efood_multivendor/controller/one-two-zero.dart';
import 'package:efood_multivendor/controller/one.dart';
import 'package:efood_multivendor/controller/one_four.dart';
import 'package:efood_multivendor/controller/one_one_seven.dart';
import 'package:efood_multivendor/controller/one_two.dart';
import 'package:efood_multivendor/controller/order_controller.dart';
import 'package:efood_multivendor/controller/product_controller.dart';
import 'package:efood_multivendor/controller/restaurant_controller.dart';
import 'package:efood_multivendor/controller/search_controller.dart';
import 'package:efood_multivendor/controller/seven.dart';
import 'package:efood_multivendor/controller/splash_controller.dart';
import 'package:efood_multivendor/controller/theme_controller.dart';
import 'package:efood_multivendor/controller/three.dart';
import 'package:efood_multivendor/controller/two.dart';
...
import '../controller/chicker_controller.dart';
import '../controller/combo.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(() => NineTwoController(categoryRepo: Get.find()));
  Get.lazyPut(() => OneOneFourController(categoryRepo: Get.find()));
  Get.lazyPut(() => OneOneEightController(categoryRepo: Get.find()));
  Get.lazyPut(() => OneOneNineController(categoryRepo: Get.find()));
  Get.lazyPut(() => OneTwoZeroController(categoryRepo: Get.find()));
  // Get.lazyPut(() => OneTwoOneController(categoryRepo: Get.find()));
  Get.lazyPut(() => OneTwoTwoController(categoryRepo: Get.find()));
  // Get.lazyPut(() => CategoryMuttonController(categoryRepo: Get.find()));
  Get.lazyPut(() => CategoryComboController(categoryRepo: Get.find()));
  // Get.lazyPut(() => CategoryFishController(categoryRepo: Get.find()));
  Get.lazyPut(() => CategoryChickenController(categoryRepo: Get.find()));
  Get.lazyPut(() => OneController(categoryRepo: Get.find()));
  Get.lazyPut(() => TwoController(categoryRepo: Get.find()));
  Get.lazyPut(() => ThreeController(categoryRepo: Get.find()));
  Get.lazyPut(() => FourController(categoryRepo: Get.find()));
  Get.lazyPut(() => SevenController(categoryRepo: Get.find()));
  Get.lazyPut(() => TweleveController(categoryRepo: Get.find()));
  Get.lazyPut(() => FourteenController(categoryRepo: Get.find()));
  Get.lazyPut(() => OneOneSevenController(categoryRepo: Get.find()));
